...
const content = computed(() => {
  if (isRTL.value) {
    return {
      ...
      alertMessage: 'للوصول إلى هذا التطبيق، يجب عليك تسجيل الدخول باستخدام حساب Microsoft Azure.',
    ...
    return {
      ...
      alertMessage: 'To access this application, you must login with your Microsoft Azure account.',
